...
export type CoverageType = 'LIVE' | 'HIGHLIGHTS' | 'DELAYED' | 'CLIP' | 'ARCHIVE'
export type ExclusivityTier = 'EXCLUSIVE' | 'NON_EXCLUSIVE' | 'OPEN_NET'
export type AccessibilityType = 'T888' | 'AUDIO_DESCRIPTION' | 'VGT'
export type AccessibilityStatus = 'NOT_REQUIRED' | 'REQUIRED' | 'PLANNED' | 'CONFIRMED' | 'DELIVERED'
