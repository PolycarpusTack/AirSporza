...
export const CONTRACTS: Contract[] = [
  { id: 1, competitionId: 1, status: "valid", validFrom: "2024-07-01", validUntil: "2027-06-30", linearRights: true, maxRights: true, radioRights: true, geoRestriction: "Belgium only", sublicensing: false, fee: "€2.4M/year", notes: "Exclusive Belgian rights", territory: ['Belgium'], platforms: ['linear', 'on-demand', 'radio'], coverageType: 'LIVE' },
  { id: 2, competitionId: 2, status: "valid", validFrom: "2024-09-01", validUntil: "2027-08-31", linearRights: true, maxRights: true, radioRights: true, geoRestriction: "Belgium only", sublicensing: false, fee: "€8.1M/year", notes: "Shared with RTBF", territory: ['Belgium'], platforms: ['linear', 'on-demand', 'radio'], coverageType: 'LIVE' },
  { id: 3, competitionId: 3, status: "valid", validFrom: "2025-01-01", validUntil: "2026-12-31", linearRights: true, maxRights: false, radioRights: true, geoRestriction: "Belgium + Luxembourg", sublicensing: false, fee: "€1.2M/year", notes: "No VRT MAX streaming", territory: ['Belgium', 'Luxembourg'], platforms: ['linear', 'radio'], coverageType: 'LIVE' },
  { id: 4, competitionId: 4, status: "expiring", validFrom: "2023-01-01", validUntil: "2026-06-30", linearRights: true, maxRights: true, radioRights: false, geoRestriction: "Belgium only", sublicensing: false, fee: "€0.9M/year", notes: "Renewal negotiations started", territory: ['Belgium'], platforms: ['linear', 'on-demand'], coverageType: 'LIVE' },
  { id: 5, competitionId: 5, status: "valid", validFrom: "2025-01-01", validUntil: "2028-12-31", linearRights: true, maxRights: true, radioRights: true, geoRestriction: "Benelux", sublicensing: true, fee: "€5.5M/year", notes: "Premium package", territory: ['Belgium', 'Netherlands', 'Luxembourg'], platforms: ['linear', 'on-demand', 'radio'], coverageType: 'LIVE' },
  { id: 6, competitionId: 6, status: "none", validFrom: "", validUntil: "", linearRights: false, maxRights: false, radioRights: false, geoRestriction: "", sublicensing: false, fee: "", notes: "Rights held by RTBF", territory: [], platforms: [], coverageType: 'LIVE' },
  { id: 7, competitionId: 7, status: "draft", validFrom: "2026-01-01", validUntil: "2028-12-31", linearRights: true, maxRights: true, radioRights: true, geoRestriction: "Belgium only", sublicensing: false, fee: "TBD", notes: "In negotiation with EBU", territory: ['Belgium'], platforms: ['linear', 'on-demand', 'radio'], coverageType: 'LIVE' },
]
